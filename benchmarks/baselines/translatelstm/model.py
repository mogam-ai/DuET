...
class LstmModel(Model):
  def __init__(
    ...
    self.lstm1 = nn.GRU(hidden_dim, hidden_dim, batch_first=True, bidirectional=True)
    self.lstm2 = nn.GRU(hidden_dim * 2, hidden_dim, batch_first=True, bidirectional=True)
...
class LstmDualModel(Model):
  def __init__(
    ...
    self.utr_embedding = nn.Linear(feature_size, hidden_dim)  # one-hot encoding
    ...
    self.cds_embedding = nn.Linear(feature_size, hidden_dim)  # one-hot encoding
